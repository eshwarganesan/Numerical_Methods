...
function main()
    ...
    while(true)
        ...
        disp("[5]  Chapter 5 - Introduction to Machine learning --- EMPTY");
        disp("[6]  Chapter 6 - Numerical Differentiation --- EMPTY");
...
function Chapter6()
    ...
    %Starting menu loop, returns to main menu after user exits
    while(true)
        disp("============= Chapter 6 - Numerical Differentiation --- SKIPPED =============");
        disp("[1] Return to main menu");
...
function RK2TrapSystem()
    ...
    %printing k table 
    disp("The k1 and k2 values for each iteration are: ");
    ...
    for row = 1:iteration+1
        ...
        for col = 1:size(y0,2)
            fprintf("w(%d,%d) = [k1 = %.*f, k2 = %.*f], ",col,row-1,precision,k_1(row,col),precision,k_2(row,col));
        end
        fprintf("\n");
    end
end
...
function RK4System
    ...
    %printing k table
    disp("The k1,k2,k3 and k4 values for each iteration are: ");
    %loop through each iteration
    for row = 1:iteration+1
        %printing first column (t(i))
        fprintf("Iteration #%d: t(%d) = %.*f, ",row-1,row-1,precision,t1(row,1));
        ...
        for col = 1:size(y0,2)
            fprintf("w(%d,%d) = [k1 = %.*f, k2 = %.*f, k3 = %.*f, k4 = %.*f], ",col,row-1,precision,k_1(row,col),precision,k_2(row,col),precision,k_3(row,col),precision,k_4(row,col));
        end
        fprintf("\n");
    end
end
